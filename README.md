 ...
 |                                                     |
 |  /api/startups/create   -->  startups-create        |
 |  /api/startups/read     -->  startups-read          |
 |  /api/startups/update   -->  startups-update        |
 |  /api/startups/delete   -->  startups-delete        |
 |  /api/technologies/...  -->  techs-*                |
 +--+------+------+------+------+------+------+--------+
    |      |      |      |      |      |      |
 ...
 |--------|----------|-------------|
 | POST | `/api/startups/create` | Crear startup |
 | GET | `/api/startups/read` | Listar (filtros opcionales: `?name=&category=`) |
 | GET | `/api/startups/read/:id` | Detalle por ID |
 | PUT | `/api/startups/update/:id` | Actualizar campos permitidos |
 | DELETE | `/api/startups/delete/:id` | Eliminar por ID |
 ...
 **Body crear/actualizar:**
 ...
 | Método | Endpoint | Descripción |
 |--------|----------|-------------|
 | POST | `/api/technologies/create` | Crear tecnología |
 | GET | `/api/technologies/read` | Listar (filtros opcionales: `?sector=&adoptionLevel=`) |
 | GET | `/api/technologies/read/:id` | Detalle por ID |
 | PUT | `/api/technologies/update/:id` | Actualizar campos permitidos |
 | DELETE | `/api/technologies/delete/:id` | Eliminar por ID |
 ...
 **Body crear/actualizar:**
 ...
 > Nota: los servicios en Render plan gratuito pueden tardar hasta 50 segundos en responder la primera petición tras un periodo de inactividad.
 
 ### Startups
 
 ```bash
 # 1. Crear startup válida
 curl -X POST https://gateway-5956.onrender.com/api/startups/create \
 ...
 # 3. Listar todas
 curl https://gateway-5956.onrender.com/api/startups/read
 
 # Respuesta esperada (200 OK):
 # [{"id":2,"name":"GreenEnergy MX",...},{"id":4,"name":"TechMex",...}]
 
 # 4. Filtrar por categoría
 curl "https://gateway-5956.onrender.com/api/startups/read?category=Fintech"
 
 # Respuesta esperada (200 OK):
 # [{"id":4,"name":"TechMex","category":"Fintech",...}]
 
 # 5. Leer por ID correcto
 curl https://gateway-5956.onrender.com/api/startups/read/4
 
 # Respuesta esperada (200 OK):
 # {"id":4,"name":"TechMex",...}
 
 # 6. Leer por ID incorrecto
 curl https://gateway-5956.onrender.com/api/startups/read/9999
 
 # Respuesta esperada (404 Not Found):
 # {"message":"No encontrado"}
 
 # 7. Actualizar campos permitidos
 curl -X PUT https://gateway-5956.onrender.com/api/startups/update/4 \
   -H "Content-Type: application/json" \
 ...
 curl -X DELETE https://gateway-5956.onrender.com/api/startups/delete/5
 
 # Respuesta esperada: 204 No Content (sin cuerpo)
 
 # 9. Eliminar inexistente
 curl -X DELETE https://gateway-5956.onrender.com/api/startups/delete/9999
 ...
 curl -X POST https://gateway-5956.onrender.com/api/technologies/create \
   -H "Content-Type: application/json" \
 ...
 # 3. Listar todas
 curl https://gateway-5956.onrender.com/api/technologies/read
 
 # Respuesta esperada (200 OK):
 # [{"id":2,"name":"Docker",...},{"id":3,"name":"Blockchain",...}]
 
 # 4. Filtrar por sector
 curl "https://gateway-5956.onrender.com/api/technologies/read?sector=DevOps"
 
 # Respuesta esperada (200 OK):
 # [{"id":2,"name":"Docker","sector":"DevOps",...}]
 
 # 5. Filtrar por adoption level
 curl "https://gateway-5956.onrender.com/api/technologies/read?adoptionLevel=high"
 
 # Respuesta esperada (200 OK):
 # [{"id":2,"name":"Docker","adoption_level":"high",...}]
 
 # 6. Leer por ID correcto
 curl https://gateway-5956.onrender.com/api/technologies/read/2
 
 # Respuesta esperada (200 OK):
 # {"id":2,"name":"Docker",...}
 
 # 7. Leer por ID incorrecto
 curl https://gateway-5956.onrender.com/api/technologies/read/9999
 
 # Respuesta esperada (404 Not Found):
 # {"message":"No encontrado"}
 
 # 8. Actualizar
 curl -X PUT https://gateway-5956.onrender.com/api/technologies/update/2 \
   -H "Content-Type: application/json" \
 ...
 curl -X DELETE https://gateway-5956.onrender.com/api/technologies/delete/4
